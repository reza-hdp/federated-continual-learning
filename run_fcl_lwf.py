...
# --------------------------------
# Persistent LwF clients
# --------------------------------

# We reuse ReplayLwFClient only for
# its LwF functionality.
#
# memory_size=0 and no replay loader
# means this is an LwF-only experiment.
...
torch.save(
    ...
    "results/fcl_lwf_r3_seed2026_model.pth"
)
