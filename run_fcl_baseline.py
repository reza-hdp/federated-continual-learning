...
from src.clients.client import FederatedClient
...
for current_task in range(NUM_TASKS):
    ...
    for round_number in range(
        ...
        for client_id, client_loader in enumerate(
            current_client_loaders
        ):
        ...
        for client in clients:
            ...
            state, loss, accuracy = client.train(
...
print()
print("FedAvg-FCL Accuracy Matrix")
...
torch.save(
    ...
    "results/fcl_fedavg_baseline_r3_seed2026_model.pth"
)
